...
import { 
  Clock, ArrowRight, ShieldAlert, Sparkles, Copy, FileText, Lock, Layout, 
...
export default function TourScreen({
  ...
  const stepsData: TourStepData[] = [
    ...
    },
    {
      ...
      shortDesc: "The core challenge instruction prompt depicting flaws.",
      guidance: "Located at the top of your test booklet. This reads the real-world scenario containing raw spelling errors, logical fallacies, or weak structure. Use the 'Clone Prompt Draft' button to copy its content to your workspace for instant editing.",
      badge: "Assessor Input Scenario",
    },
    {
      title: "3. Standard AI Baseline Response",
      shortDesc: "The raw, unoptimized AI output that you must audit.",
      guidance: "This block is wrapped in an amber border. It shows the basic, underwhelming response generated by a generic AI. You must analyze its quality gaps, terminology errors, and structure to draft your refinement.",
      badge: "Flawed Reference Draft",
    },
    {
      title: "4. Your Refined Response Workspace",
      shortDesc: "Your physical interactive workbench where you edit.",
      guidance: "A secure, fullscreen editor where you type your finalized rules. To protect the psychometric integrity of the session, standard right-click actions, pasting, copy actions, and screenshot key triggers are securely blocked.",
        ...
        <div className="lg:col-span-8 bg-neutral-100/50 rounded-xl border border-neutral-250/70 p-4 flex flex-col gap-3 min-h-0 overflow-y-auto">
          ...
          <div className="flex-1 flex flex-col gap-3 min-h-0 bg-neutral-200/50 p-2.5 rounded-lg border border-neutral-300">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 min-h-0">
              ...
              <div className="flex flex-col gap-2 bg-neutral-100/70 rounded p-2.5 border border-neutral-250">
                ...
                >
                  ...
                  <div className="pt-2 mt-2 border-t border-neutral-100 flex justify-end">
                    <button className="flex items-center gap-1 bg-amber-50 border border-amber-200 text-amber-800 px-1.5 py-0.5 rounded text-[7px] font-black pointer-events-none uppercase tracking-wider">
                      <Copy className="w-2 h-2" /> Clone Prompt Draft
                    </button>
                  </div>
                </motion.div>
              ...
              {/* Right Column: Writing Intervention Editor Panel Mock */}
              <div className="flex flex-col gap-2 bg-neutral-100/70 rounded p-2.5 border border-neutral-250">
                <div className="border-b border-neutral-250 pb-1.5 flex justify-between items-center text-[9px] font-bold text-neutral-400 uppercase tracking-wider">
                  <span>Your Revision Sandbox</span>
                </div>

                {/* Box 4: Your Refined Response Workspace Module */}
                <motion.div
                  initial={{ opacity: 0, scale: 0.98 }}
                  animate={{ opacity: 1, scale: 1 }}
